...
func Explorer(okno strapi.StrapiRestClient, apis map[string][]handlers.API, jormCommands *handlers.JormCmds, exJDBs map[string]*explorer.ExplorerJDBs, r *fiber.App) {
